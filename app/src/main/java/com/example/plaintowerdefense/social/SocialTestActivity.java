...
public class SocialTestActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        // 로그인 상태 표시
        nicknameTextView = findViewById(R.id.nickname_tv_social_test);
        profileImageView = findViewById(R.id.profile_iv_social_test);
        ...
        userRecyclerView = findViewById(R.id.rv_social_test);
        ...
        addFriendButton = findViewById(R.id.add_friend_bt_social_test);
    ...
    public void onClick(View v) {
        ...
        switch(id){
            // 친구 추가 버튼
            case R.id.add_friend_bt_social_test:
                addFriendDialog();
                break;
            default:
