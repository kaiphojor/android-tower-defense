...
public class SocialListviewActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        // 로그인 상태 표시
        idTextView = findViewById(R.id.username_tv_social_listview);
        profileImageView = findViewById(R.id.profile_iv_social_listview);
        ...
        userListview = findViewById(R.id.lv_social_listview);
//        adapter = new UserRecyclerViewAdapter(userList);
//        final UserListViewAdapter listViewAdapter = new UserListViewAdapter(this,userList);
        listViewAdapter = new UserListViewAdapter(this,userList);
                listViewAdapter.setOnButtonClickListener(new UserListViewAdapter.OnButtonClickListener(){
            // item 메모 수정
            @Override
...
//        userListview.setLayoutManager(new LinearLayoutManager(this)) ;
         ...
         */
        addFriendButton = findViewById(R.id.add_friend_bt_social_listview);
    ...
    public void onClick(View v) {
        ...
        switch(id){
            // 친구 추가 버튼
            case R.id.add_friend_bt_social_listview:
                addFriendDialog();
                break;
            default:
